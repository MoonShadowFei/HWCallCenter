 ...
 */
function agentCallOperation_showCallOut(obj) {
 ...
 */
function agentCallOperation_showSecondDial(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
 ...
 */
function agentCallOperation_showTransfer(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
 ...
 */
function agentCallOperation_showUnHold(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
 ...
 */
function agentCallOperation_showThreeParty(obj) {
    if ($(obj).attr("disabled") == "disabled") retusrn;
 ...
 */
function agentCallOperation_showInnerCall(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
 ...
 */
function agentCallOperation_showInnerHelp(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
 ...
 * To answer call
 */
function agentCallOperation_toAnswer(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
 ...
 *To hangup call
 */
function agentCallOperation_toHangUp(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
 ...
 */
function agentCallOperation_toHold(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
...
function agentCallOperation_toThreeParty(currentCallId) {
    ...
    var retJson = VoiceCall.confJoin({
        "agentid": global_agentInfo.agentId,
...
function agentCallOperation_toInnerCall(agentWorkno) {
    var retJson = VoiceCall.callInner({
        "agentid": global_agentInfo.agentId,
 ...
 * To metu call
 */
function agentCallOperation_toMetu(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
 ...
 * To unmetu call
 */
function agentCallOperation_toUnMetu(obj) {
    if ($(obj).attr("disabled") == "disabled") return;
        ...
        $callback: function (result, data) {
            ...
            switch (retcode) {
                case global_resultCode.SUCCESSCODE:
                    ...
                    html = "<div class='msg_customer'><h2><span>" + "Customer" + "&nbsp;" + curTime
								+ "</span></h2></div><div><span class='msg_content'>" +
content + "</span></div>";
